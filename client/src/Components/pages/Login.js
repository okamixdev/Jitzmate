      ...
      <div className='container'>
        ...
        <div className='signup-cont'>
          <form className='signup-form' onSubmit={handleSignUpSubmit}>
            <label for='chek' aria-hidden='true'>Sign Up</label>
            <input type='text' required='true' placeholder='First Name' name="first" value={userRegisterData.first} onChange={handleInputSignChange} />
            <input type='text' required='true' placeholder='Last Name' name="last" value={userRegisterData.last} onChange={handleInputSignChange} />
            <input type='text' required='true' placeholder='Username' name="username" value={userRegisterData.username} onChange={handleInputSignChange} />
            <input type='text' required='true' placeholder='Email' name="email" value={userRegisterData.email} onChange={handleInputSignChange} />
            <input type='password' required='true' placeholder='Password' name="password" value={userRegisterData.password} onChange={handleInputSignChange} />
        ...
        <div className='login-cont'>
          <form className='login-form' onSubmit={handleLoginSubmit}>
            <label for='chek' aria-hidden='true'>Login</label>
